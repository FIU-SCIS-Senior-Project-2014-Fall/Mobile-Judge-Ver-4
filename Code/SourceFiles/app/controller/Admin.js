...
Ext.define('OnlineJudges.controller.Admin', {
    ...
    config: {
        ...
        control: {
            ...
            "invitations": {
                //show: 'onEmailShow',
                activeitemchange: 'onInvitationsActiveItemChange',
                //hide: 'onEmailHide'
            },
            "email selectfield": {
            ...
            "invitations button[name=addTemplate]":{
                tap: 'onAddTemplateTap'
            },
            ...
            "pastJudgesOptions checkboxfield[name=attendedJudges]": {
                check: 'onPJOattendedCheck',
                uncheck: 'onPJOattendedUncheck'
            },
            "pastJudgesOptions checkboxfield[name=gradedJudges]": {
                check: 'onPJOgradedCheck',
                uncheck: 'onPJOgradedUncheck'
            },
    ...
    onPJOattendedCheck:function(){
        //alert('onPJOattendedCheck');
        var pjo = this.getPastJudgesOptions();
        var pendingtPjo = pjo.down('checkboxfield[name=pendingJudges]');
        var all = pjo.down('checkboxfield[name=invitedJudges]');
        var declinedPjo = pjo.down('checkboxfield[name=declinedJudges]');
    ...
    onPJOattendedUncheck:function(){
        var pjo = this.getPastJudgesOptions();
        var all = pjo.down('checkboxfield[name=invitedJudges]');
        all.uncheck();
    },
    onPJOgradedCheck:function(){
        //alert('onPJOgradedCheck');
        var pjo = this.getPastJudgesOptions();
        var pendingtPjo = pjo.down('checkboxfield[name=pendingJudges]');
        var all = pjo.down('checkboxfield[name=invitedJudges]');
        var declinedPjo = pjo.down('checkboxfield[name=declinedJudges]');
        ...
        var acceptedPjo = pjo.down('checkboxfield[name=acceptedJudges]');
        var attendedPjo = pjo.down('checkboxfield[name=attendedJudges]');
        acceptedPjo.check();
        attendedPjo.check();
    },
    onPJOgradedUncheck:function(){
        var pjo = this.getPastJudgesOptions();
        var all = pjo.down('checkboxfield[name=invitedJudges]');
        all.uncheck();
    },
    onPJOinvitedUncheck:function(){
        var pjo = this.getPastJudgesOptions();
        var all = pjo.down('checkboxfield[name=invitedJudges]');
        all.uncheck();
    },
    ...
    onPJOinvitedCheck: function(){
        ...
        var declinedPjo = pjo.down('checkboxfield[name=declinedJudges]');
        var attendedPjo = pjo.down('checkboxfield[name=attendedJudges]');
        var gradedPjo = pjo.down('checkboxfield[name=gradedJudges]');
        pendingtPjo.check();
        acceptedPjo.check();
        declinedPjo.check();
        attendedPjo.check();
    ...
    onPastJOptionsOKTap: function(){
        ...
        pjo.hide();
        var invitations = main.down("invitations");
        invitations.next();
    },
    ...
    setJudgesStoreFilter: function () {
        ...
        var pastAttended = pastJO.down('checkboxfield[name=attendedJudges]');
        var pastGraded = pastJO.down('checkboxfield[name=gradedJudges]');
            ...
            if (activeJudges.getChecked() === true) {
                ...
                for (var i = 0; i < terms.length; i++) {
                    ...
                    for (var j = 0; j < pastTerms.length; j++)
                        if (pastTerms[j] == terms[i]) {
                            wasTermSelected = true;
                        }
                    ...
                    //Checking past Attended
                    if (pastAttended.getChecked() === true && responses[i] === '2') {
                        record.data.Response = 2;
                        return record;
                    }

                    //Checking past graded
                    if (pastGraded.getChecked() === true && responses[i] === '3') {
                        record.data.Response = 3;
                        return record;
                    }
                }
            }
    ...
    onBackBtnTap: function(){
        ...
        if (navBtn.from == 'Email') {
            email = main.down("email");
            email.previous();
        } else if (navBtn.from == 'InvitationsTab') {
            invitations = main.down("invitations");
    ...
    onPeopleTabChange: function (container, value) {
        ...
        var navBar = this.getMain().getNavigationBar(),
            ...
            console.log('name: '+ value.getActiveItem().name);
        //Tab invitation
        if (value.getActiveItem().name === 'filterInvitationPanel') {
        ...
        else if (value.getActiveItem().name === 'listInvitationPanel'){
            AddJudgeBtn = this.getAddJudgeBtn();
            AddJudgeBtn.hide();
            ...
            backBtn.show();
            backBtn.from = 'InvitationsTab'
            navBtn.setText('');
            navBtn.setIconCls('arrow_right');
            navBtn.from = 'InvitationsTab'
            navBar.setTitle('Invitations');
        }
        else if (value.getActiveItem().name === 'sendInvitationPanel'){
            AddJudgeBtn = this.getAddJudgeBtn();
            AddJudgeBtn.hide();
...
onInvitationsActiveItemChange: function (container, value, oldValue, eOpts) {
        ...
        if (value.name === 'sendInvitationPanel') {
            navBtn.setText('Send');
            navBtn.setIconCls('');
            navBtn.show();
            backBtn.show();
            ...
            var GradeSaveBtn = this.getGradeSaveBtn();
            GradeSaveBtn.hide();

        } else if (value.name === 'listInvitationPanel'){
            var AddJudgeBtn = this.getAddJudgeBtn();
            AddJudgeBtn.hide();
            ...
            if (value.name === 'filterInvitationPanel')
            {
            	navBtn.hide();
            }
    ...
    onNavBtnTap: function () {
        ...
        //NEW: implementing sending function on invitations tab
            ...
            var invitations = me.getMain().down("invitations");
            button.from = 'InvitationsTab';
            if (invitations.getActiveItem().name === 'sendInvitationPanel') {
                var templateSelect = invitations.down('selectfield[name=templates]');
    ...
    onSettingsTabShow: function () {
        var navBtn = this.getNavBtn(),
            ...
            termselect = mainView.down('[@name=Term]');			
		...
		Ext.php.Settings.load(function (settings) {
			termselect.setOptions(settings.terms);
