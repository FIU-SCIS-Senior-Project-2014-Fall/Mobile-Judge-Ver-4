...
class Settings {
    ...
    public function load() {
		...
		$db->sql('SELECT DISTINCT termInitiated as Term FROM `term`');
		$term_res = $db->getResult();
		
		$terms = array();
		
		foreach ($term_res as $r)
		{
			$terms[] = array('text'=>$r['Term'], 'value' => $r['Term']);
		}
    ...
    public function save($settings) {
        ...
        {
        	//download it
        	$mapimage_data = file_get_contents($settings->MapImage);
